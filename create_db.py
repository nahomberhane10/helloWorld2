...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'nahomb@terpmail.umd.edu', 'email': 'nahomb@terpmail.umd.edu', 'first_name': 'Nahom', 'last_name': 'Berhane',
         'password': generate_password_hash('nahomb@terpmail.umd.edu', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'Nahom', 'last_name': 'Berhane', 'email': 'nahomb@terpmail.umd.edu',
         'major_id': 3, 'birth_date': dt.strptime('2004-01-01', '%Y-%m-%d'), 'is_honors': 1}
    ]
